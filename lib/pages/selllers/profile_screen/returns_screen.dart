...
class ReturnsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: "Буцаалт"),
      body: Consumer<ReturnsScreenViewModel>(builder: (context, model, __) {
        return ListView.builder(
          itemCount: model.returnsList.length,
          itemBuilder: (context, index) {
            final returns = model.returnsList[index];
            return Column(
              children: [
                Container(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      unit(double.parse(returns["price"])),
                                      maxLines: 2,
                                      style: const TextStyle(
                                        fontSize: 15,
